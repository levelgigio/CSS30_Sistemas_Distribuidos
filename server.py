...
class RideSharingServer(object):
    ...
    def add_offered_ride(self, ride):
        ...
        for wanted_ride in self.wanted_rides:
            if wanted_ride.get_location() == ride.get_location() and wanted_ride.get_date() == ride.get_date() and wanted_ride.get_passengers() == ride.get_passengers():
    ...
    def add_wanted_ride(self, ride):
        ...
        for offered_ride in self.offered_rides:
            if offered_ride.get_location() == ride.get_location() and offered_ride.get_date() == ride.get_date() and offered_ride.get_passengers() == ride.get_passengers():
